...
def inicio_est(correo_electronico, curp):
    ...
    return render_template('verCalifAlu.html', estudiante=est, materia=m_inscrita, bandera3=1, promedios=u )
...
def cambiar_calificacion_Bimestre1(id_materia, id_estudiante, id_profesor,grado):
    if "username" in session and session["username"] =='ADMINISTRADOR':
        if request.method == 'POST':
            ...
            campo5_B1 = 0
            if grado == 'K1' or 'K2' or 'K3':
                promedio = (float(campo1_B1)*.60) + ((campo2_B1)*.15) + ((campo3_B1)*.10) + ((campo4_B1)*.15)
            else:
                promedio = (float(campo1_B1)*.50) + ((campo2_B1)*.15) + ((campo3_B1)*.15) + ((campo4_B1)*.10)
            try:
...
def cambiar_calificacion_Bimestre2(id_materia, id_estudiante, id_profesor, grado):
    if "username" in session and session["username"] =='ADMINISTRADOR':    
        if request.method == 'POST':
            ...
            campo5_B2 = 0
            if grado == 'K1' or 'K2' or 'K3':
                promedio = (float(campo1_B2)*.60) + ((campo2_B2)*.15) + ((campo3_B2)*.10) + ((campo4_B2)*.15)
            else:
                promedio = (float(campo1_B2)*.50) + ((campo2_B2)*.15) + ((campo3_B2)*.15) + ((campo4_B2)*.10)
            try:
...
def cambiar_calificacion_Bimestre3(id_materia, id_estudiante, id_profesor, grado):
    if "username" in session and session["username"] =='ADMINISTRADOR':
        if request.method == 'POST':
            ...
            campo5_B3 = 0
            if grado == 'K1' or 'K2' or 'K3':
                promedio = (float(campo1_B3)*.60) + ((campo2_B3)*.15) + ((campo3_B3)*.10) + ((campo4_B3)*.15)
            else:
...
def cambiar_calificacion_Bimestre4(id_materia, id_estudiante, id_profesor, grado):
    if "username" in session and session["username"] =='ADMINISTRADOR':
        if request.method == 'POST':
            ...
            campo5_B4 = 0
            if grado == 'K1' or 'K2' or 'K3':
                promedio = (float(campo1_B4)*.60) + ((campo2_B4)*.15) + ((campo3_B4)*.10) + ((campo4_B4)*.15)
            else:
